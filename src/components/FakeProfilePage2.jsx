        ...
        {ready ? (!edit ? (
            <div className="profileFields">
                <span className="profileInput" id="yearInput">
                    <label>Year:</label>
                    <span className="profileText" id="yearText">Junior</span>
                </span>
                <span class="profileInput" id="bioInput">
                    <label>Bio:</label>
                    <span className="profileText" id="bioText">I enjoy long walks to the Commuter North Bus stop at 8AM</span>
                </span>
                <span class="profileInput" id="skillsInput">
                    <label>Skills:</label>
                    <span className="profileText" id="skillsList">UI/UX Design, Prototyping, React</span>
                </span>
...
export default FakeProfilePage2;